        ...
        <nav className="bg-white border-b border-zinc-200 sticky top-0 z-40 backdrop-blur bg-white/80">
            <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
                ...
                <div className="flex items-center gap-4">
                    <Link to="/loan" className="text-sm text-zinc-600 hover:text-zinc-900">Simulador</Link>
                    
                    {token ? (
                        <>
                            <Link to="/dashboard" className="text-sm text-zinc-600 hover:text-zinc-900">Mi Dashboard</Link>
                            <button 
                                onClick={logout} 
                        ...
                        <>
                            <Link to="/login" className="text-sm text-zinc-600 hover:text-zinc-900">Login</Link>
                            <Link 
                                to="/register" 
